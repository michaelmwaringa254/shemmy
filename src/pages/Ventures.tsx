  ...
  const ventures = [
    {
      ...
      logo: "https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&cs=tinysrgb&w=400",
      backgroundImage: "https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&cs=tinysrgb&w=800",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
              {ventures.map((venture, index) => (
                ...
                <div 
                  ...
                  style={{ backgroundImage: `url(${venture.backgroundImage})` }}
                >
